...
PAGES = {
    ...
    '/om/': 0.7,
    '/trender/': 0.95,
    '/e-post-sikkerhet/': 0.95,
    '/mail-sikkerhet/': 0.9,
    '/email-security-norway/': 0.85,
    '/sammenligning/': 0.85,
    '/sammenligning/data1-vs-mxtoolbox/': 0.8,
    '/sammenligning/data1-vs-easydmarc/': 0.8,
    '/sammenligning/data1-vs-dmarcian/': 0.8,
    '/sammenligning/data1-vs-valimail/': 0.8,
    '/ordbok/': 0.85,
    '/sertifikat/': 0.6,
    '/blogg/': 0.7,
    '/blogg/dmarc/': 0.85,
